    ...
    <div data-role="page" class="jqm-demos" data-title="ฐานข้อมูลสำหรับคริสตจักรนิมิตบ้านโฮ่ง">
        ...
        <h1>เพิ่มสมาชิก</h1>
            <div role="main" class="ui-content">
                <form method="post" action="member_register_check.php" data-ajax="false" data-role="fieldcontain">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                ...
                                <input type="text" name="idcard" id="un" value="" placeholder="รหัสบัตรประจำตัวประชาชน" data-theme="a">
                            </td>
                            <td></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <th></th>
                            <td>
                                <button type="submit" name="submit" class="ui-btn ui-corner-all ui-btn-b">ยืนยันการเพิ่มสมาชิก</button>
                            </td>
                            <td></td>
                        </tr>
                    </tbody>  
