    ...
    <div data-role="page" class="jqm-demos" data-title="ฐานข้อมูลสำหรับคริสตจักรนิมิตบ้านโฮ่ง">
        ...
        <h1>เพิ่มผู้ใช้งาน</h1>
            <div role="main" class="ui-content">
                <form method="post" action="user_register_check.php" data-ajax="false" data-role="fieldcontain">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                ...
                                <input type="text" name="username" id="username" onblur="validateUsername(this)" value="" placeholder="ชื่อผู้ใช้งาน" data-theme="a">
                            </td>
                            <td>*ภาษาอังกฤษ A-Z,a-z,0-9 มากกว่า 6 ตัวอักษร</td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                ...
                                <label for="pw" class="ui-hidden-accessible">Password:</label>
                                <input type="password" name="confirm" id="pw" value="" placeholder="ยืนยันรหัสผ่าน" data-theme="a">
                            </td>
                            <td></td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <select name="usergroup" id="" data-native-menu="">
                                    <option>กรุณาเลือกกลุ่มผู้ใช้งาน</option>
                                    <option value="sa">ผู้ดูแลระบบ</option>
                                    <option value="mb">ผู้ดูแลข้อมูลสมาชิก</option>
                                    <option value="sm">ผู้จัดการการอบรม</option>
                                    <option value="fn">ผู้ดูแลการเงิน</option>
                                    <option value="am">ผู้บริหาร</option>
                                </select>
                            </td>
                            <td></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input type="email" name="email" id="email" onblur="check_email(this)" value="" placeholder="อีเมลล์" data-theme="a">
                            </td>
                            <td></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <th></th>
                            <td>
                                <button type="submit" name="submit" class="ui-btn ui-corner-all ui-btn-b">ยืนยันการเพิ่มผู้ใช้งาน</button>
                            </td>
                            <td></td>
                        </tr>
                    </tbody>  
