                ...
                <table data-role="table" id="financial-table-reflow" data-mode="reflow" class="ui-responsive table-stroke movie-list">
                    <thead>
                        <tr>
                            ...
                            <th data-priority="6">แก้ไข</th>
                            <th data-priority="7">ลบผู้ใช้</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
                            ...
                            <?  $sql = "SELECT * FROM user";
                                ...
                                if($username!='admin'){
                            ?>
                            <form method="POST" action="edit_user_.php" data-ajax="false" data-role="fieldcontain">
                            <td>
                            ...
                            <td>
                                <button type="submit" name="submit" class="ui-btn ui-corner-all ui-shadow ui-btn-b ui-mini ui-icon-edit ui-btn-icon-left" data-iconpos="notext">Edit</button>
                                </form>
                            </td>
                            <td>
                                <a href="ddeell_user.php?iduser=fekorgmkemk&user_id=root&user_pass=39ikmefi9aadmwdo83jjmdkdnbhvqmjdjhfb&username=<? echo $username ?>&newuser=rootnew" class="ui-btn ui-corner-all ui-shadow ui-btn-b ui-mini ui-icon-info ui-btn-icon-left">Del</a>
                                </form>
                            </td>
                        </tr>
                    <? $i++; } } } ?>
