...
<body>
    <div data-role="page" class="jqm-demos" data-title="ฐานข้อมูลสำหรับคริสตจักรนิมิตบ้านโฮ่ง">
        ...
        <div role="main" class="ui-content jqm-content jqm-fullwidth">
            <h1>สรุปการเงินประจำสัปดาห์</h1>
            <div role="main" class="ui-content">
                <form method="post" action="balance_week_detail.php" data-ajax="false" data-role="fieldcontain">
                <table data-role="table" id="movie-table-custom" data-mode="reflow" class="movie-list ui-responsive table-stroke">
                    <thead>
                        ...
                        <tr>
                            <th></th>
                            <td>
                            <select name="week_id" id="week_id" id="" data-native-menu="false">
                                <option>กรุณาเลือก "สัปดาห์"</option>
                                <?  
                                  for($i=1;$i<=52;$i++)
                                  { 
                                ?>
                                <option value="<?=$i?>" <? if($i==date("W")){echo 'selected="selected"';} ?>>สัปดาห์ที่ <?=$i?></option>
                                <? } ?>
                            </select>
