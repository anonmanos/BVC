    ...
    <script>
            ...
            var chartData = [
                ...
                <?  //นับจำนวนผู้ลงทะบียน
                                ...
                                $sql		= "SELECT * FROM courseregis WHERE course_detail_id like '%$course_id%' and course_regisdate like '%$year_id%'";
    ...
    <div data-role="page" class="jqm-demos" data-title="ฐานข้อมูลสำหรับคริสตจักรนิมิตบ้านโฮ่ง">
        ...
        <div role="main" class="ui-content jqm-content jqm-fullwidth">
           <?  //นับจำนวนผู้ลงทะบียน
            ...
            ?>
            <h1>สรุปการลงทะเบียนเข้าอบรมแต่ละหลักสูตรประจำปี <?=$year_id?></h1>
