    ...
    <div data-role="page" class="jqm-demos" data-title="ฐานข้อมูลสำหรับคริสตจักรนิมิตบ้านโฮ่ง">
        ...
        <div role="main" class="ui-content jqm-content jqm-fullwidth">
            ...
            <div role="main" class="ui-content">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <ul data-role="listview" data-inset="true" data-filter="true" data-filter-reveal="true" data-input="#inset-autocomplete-input" data-ajax="false">
                                    ...
                                    ?>
                                    <li>
                                        <a href="course_register_add_check.php?course_detail_id=<?=$course_detail_id?>&newuser=root&trainer_id=<?=$trainer_id?>&member_idcard=<?=$rows["member_idcard"];?>" data-ajax="false">ลงทะเบียน
                ...
                <!--<a href="course_register_add.php?course_detail_id=<?=$row['course_detail_id']?>&newuser=root&trainer_id=<?=$trainer_id?>" class="ui-btn ui-corner-all ui-btn-b ui-icon-action ui-btn-icon-left" data-theme="b" data-ajax="false">ลงทะเบียน</a>-->
